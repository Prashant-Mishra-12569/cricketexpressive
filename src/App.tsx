      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/ipl-2025" element={
            <EmptyPage 
              title="IPL 2025" 
              description="Follow the latest news, standings, and match updates from the Indian Premier League 2025 season. Content is managed through the WordPress admin panel."
            />
          } />
          <Route path="/news" element={
            <EmptyPage 
              title="Cricket News" 
              description="Stay updated with the latest cricket news from around the world. All content is manageable through the WordPress admin interface."
            />
          } />
